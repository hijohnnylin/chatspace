    ...
    **vllm_kwargs :
        ...
        return SteeringSpec(
            layers={
                layer: LayerSteeringSpec(
                    operations=[AddSpec(vector=unit, scale=norm * scale)]
                )
            }
        )
    ...
    def simple_projection_cap(
        ...
        return SteeringSpec(
            layers={
                layer: LayerSteeringSpec(
                    operations=[ProjectionCapSpec(vector=unit, min=min, max=max)]
                )
            }
        )
    ...
    def simple_ablation(
        ...
        return SteeringSpec(
            layers={
                layer: LayerSteeringSpec(
                    operations=[AblationSpec(vector=unit, scale=scale)]
                )
            }
        )
